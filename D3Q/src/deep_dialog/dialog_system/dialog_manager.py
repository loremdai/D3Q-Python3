    ...
    def next_turn(self,
        ...
        if not simulation_for_discriminator:
            ...
            if self.use_model:
                ...
                self.discriminator.store_user_experience((self.state_user, self.agent.action, self.state_user_next,
                                                          self.reward, self.episode_over, self.user_action))
            ...
            return (
            self.state_user, self.agent.action, self.state_user_next, self.reward, self.episode_over, self.user_action)
